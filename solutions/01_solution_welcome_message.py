...
INSTRUCTIONS:
-------------
You're building a welcome system for a small business's internal portal.
1. Define a function print_welcome() that prints the following banner:
    ***********************************
    Welcome to the Acme Analytics Portal!
...
def print_welcome():
    ...
    print("Your business insights await.")
    print("***********************************")
